...
about criterion 1E in section 3.
...
similar (_e.g._, where it's hot, it's also very dry, and there's also
...
This is the hardest section to do properly (I think) and it's the one
...
data into training vs. validation subsets. We train (build) the model
...
![*Figure 3. Receiver Operating Characteristic Curves (ROC curves)*. Taken from wikipedia (look, it's a good diagram!): [https://en.wikipedia.org/wiki/Receiver_operating_characteristic](https://en.wikipedia.org/wiki/Receiver_operating_characteristic). Description in the text.](https://en.wikipedia.org/wiki/Receiver_operating_characteristic){fig-align="center"}
...
perhaps... [https://sphere-ppl.org/pages/Forecasting_Contests/](enter
our forecasting contest!) And win a fabulous prize!...
